...
public class VerifytheUserCannotSignupWithouEnteringPassword {
	...
	public void verifyLogin() throws InterruptedException {
		...
		driver.findElement(By.xpath("//label[text()='Re-Enter Password']/following-sibling::input")).sendKeys("1234");
