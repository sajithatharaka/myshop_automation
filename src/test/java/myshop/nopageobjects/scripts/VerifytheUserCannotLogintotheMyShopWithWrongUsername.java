...
public class VerifytheUserCannotLogintotheMyShopWithWrongUsername {
	...
	public void verifyLogin() throws InterruptedException {
		...
		driver.findElement(By.xpath("//label[text()='User Name']/following-sibling::input")).sendKeys("user");
