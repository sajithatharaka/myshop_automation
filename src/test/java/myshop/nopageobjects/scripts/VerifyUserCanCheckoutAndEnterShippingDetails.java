...
public class VerifyUserCanCheckoutAndEnterShippingDetails {
	...
	public void verifyLogin() throws InterruptedException {
		...
		driver.findElement(By.xpath("//label[text()='House Number']/following-sibling::input")).sendKeys("13");
		driver.findElement(By.xpath("//label[text()='Street']/following-sibling::input")).sendKeys("Chiltern View");
		driver.findElement(By.xpath("//label[text()='Town/City']/following-sibling::input")).sendKeys("Colombo");
		driver.findElement(By.xpath("//label[text()='Country']/following-sibling::input")).sendKeys("Sri Lanka");		
